...
function falloerror(campo) {
  if (document.getElementById(campo).value == '') {
    //document.getElementById("txt-correo").focus();
    document.getElementById(campo).classList.add('error_login');
    //document.getElementById("txt-password").classList.add('error_login');
    //document.getElementById('div-error-'+campo).style.display = 'block';
    return false;
  } else {
    document.getElementById(campo).classList.remove('error_login');
    //document.getElementById("txt-password").classList.add('error_login');
